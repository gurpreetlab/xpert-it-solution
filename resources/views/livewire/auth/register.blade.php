<x-layouts::auth.split :title="__('Register')">
    <div class="flex flex-col gap-6">
        ...
        <div class="space-y-2.5">
            ...
            <a href="{{ route('auth.facebook.redirect') }}" class="flex items-center justify-center gap-3 w-full py-2.5 px-4 rounded-xl border border-zinc-200 bg-white hover:bg-zinc-50 text-sm font-semibold text-zinc-700 shadow-sm transition">
