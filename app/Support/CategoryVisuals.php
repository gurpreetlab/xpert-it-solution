...
class CategoryVisuals
{
    ...
    private const DEFAULT_PILL = "text-zinc-600 dark:text-zinc-400 bg-zinc-50 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800";
    private const DEFAULT_GRADIENT = ["from-zinc-800", "from-zinc-700"];
